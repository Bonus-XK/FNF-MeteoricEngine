...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(ClientPrefs.checkForUpdates) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/Bonus-XK/FNF-MeteoricEngine/main/gitVersion.txt");
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Meteoric Engine by'], 15);
					#else
					createCoolText(['Bonus-XK']);
					#end
				// credTextShit.visible = true;
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('Bonus-XK', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.text = 'A Shit Shit Engine';
				// credTextShit.screenCenter();
				case 10:
