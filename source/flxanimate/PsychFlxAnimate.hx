...
/**
 * Psych Engine 1.0.4 兼容的 FlxAnimate 包装：补上 loadAtlasEx /
 * pauseAnimation / resumeAnimation。
 * English: Psych Engine 1.0.4-compatible FlxAnimate wrapper that adds
 * loadAtlasEx / pauseAnimation / resumeAnimation on top of the haxelib.
 */
